...
const ProductScreen = ({ navigation, route }) => {
    ...
    const INITIAL_URL = route.params.initialUrl;
    //console.log('INITIAL_URL', INITIAL_URL);
    
    const URL_IDENTIFAIRE = route.params.initialId;
    //console.log('URL_IDENTIFAIRE', URL_IDENTIFAIRE);

    const FATCH_TO_OUR_BACK = route.params.initialUrlToOurBack;
    console.log('FATCH_TO_OUR_BACK in WB', FATCH_TO_OUR_BACK);
